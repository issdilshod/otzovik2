            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex">
                        <h3 class="card-title mr-auto">{{__('comments_list_title')}}</h3>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ml-2">
                                <a class="btn btn-sm btn-primary" href="{{url('admin/blog/comment')}}">
                            ...
                            @foreach ($list as $key => $value)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="d-flex">
                                            <div class="ml-auto">
                                                <a href="{{url('admin/blog/comment/'.$value->id)}}" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-pen" aria-hidden="true"></i>
                                                </a>
                                            </div>
                                            <form class="ml-1" action="{{url('admin/blog/comment/'.$value->id)}}" method="post">
                                                @csrf
