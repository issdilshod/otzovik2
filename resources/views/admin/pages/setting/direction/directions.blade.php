                    ...
                    <div class="card-header d-flex">
                        ...
                        <div class="d-flex">
                            <div style="width: 150px;">
                                <form class="input-group input-group-sm d-flex" action="{{url('admin/settings/direction')}}" method="get">
                                    @csrf
                            ...
                            <div class="ml-2">
                                <a class="btn btn-sm btn-primary" href="{{url('admin/settings/direction')}}">
                            ...
                            @foreach ($list as $key => $value)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="d-flex">
                                            <div class="ml-auto">
                                                <a href="{{url('admin/settings/direction/'.$value->id)}}" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-pen" aria-hidden="true"></i>
                                                </a>
                                            </div>
                                            <form class="ml-1" action="{{url('admin/settings/direction/'.$value->id)}}" method="post">
                                                @csrf
